# -*- coding: utf-8 -*-
"""
Created on Tue Mar 29 12:01:18 2022
...
#                print(gabor_label)
                ...
                phi = 0.8  #0.8 for hidden image. Otherwise leave it to 0
                ...
                cv2.imwrite('gabor_filtered_images1/'+gabor_label+'.jpg', filtered_img.reshape(img.shape))
